...
if(vacaPrice < budget && taxReturn >= 5000){ //if the price of the vacation is less than our budget and tax returns is greater than or equal to 5000 we can go on vacation.
